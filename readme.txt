...
Python (3.6+) version of CLIMADA release v1.4.1 or later
...
Starting with the jupyter-notebook 'demo_data_aggregation.ipynb'

The output generated is an example for gaining the results presented in Fig.2-5 and Fig. SI1 and SI2
for the example of Latin America. Please note that results are only partly compareable to paper results,
as we are not allowed to publish observed damages.

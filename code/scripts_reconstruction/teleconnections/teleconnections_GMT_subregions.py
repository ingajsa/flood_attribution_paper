...
def extract_model_coefs_short(region, model, link, dis):
    ...
    DATA_ATTR.to_csv('../../../data/reconstruction/ENSO_GMT_PDO_NAO_subregions.csv')     
...
for i, test_region in enumerate(test_regions):
    ...
    if test_region != 'NAM':
        ...
        loo_df_pos.to_csv('../../../data/reconstruction/LooIC_ENSO_PDO_NAO_GMT_{}_pos.csv'.format(test_region))
        ...
        DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_pos', 'pval_residual_trend_gmt_run'] = pvalPos
        DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_pos', 'residual_trend_gmt_run'] = coefPos

        
        DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_pos', 'Unexplained Trend'] = unexTPos
        
        DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_pos', 'R2_D_1980_bm_gmt_run'] = pearson_corrPos
        
        DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_pos', 'oose_gmt_run'] = best_looPos
    ...
    loo_df_neg.to_csv('../../../data/reconstruction/LooIC_ENSO_PDO_NAO_GMT_{}_neg.csv'.format(test_region))
    ...
    DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_neg', 'pval_residual_trend_gmt_run'] = pvalNeg

    DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_neg', 'residual_trend_gmt_run'] = coefNeg

    DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_neg', 'Unexplained Trend'] = unexTNeg

    DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_neg', 'R2_D_1980_bm_gmt_run'] = pearson_corrNeg

    DATA_ATTR.loc[DATA_ATTR['Region'] == test_region+'_neg', 'oose_gmt_run'] = best_looNeg

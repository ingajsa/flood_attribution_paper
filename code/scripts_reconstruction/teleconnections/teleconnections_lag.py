...
def test_residuals(model, timeperiod,reg):
    ...
    fig.savefig('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Response_letter/Autocorr_Residuals/AutocorrResidualsGMT_{}.png'.format(reg),bbox_inches = 'tight',dpi =600)
...
def extract_model_coefs_short(region, model, link):
    ...
    DATA_ATTR.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/Lag_ENSO_GMT_PDO_NAO_Loo.csv')
...
for i, test_region in enumerate(test_regions):
    ...
    loo_df.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/LooIC_ENSO_GMT_PDO_NAO_Loo_{}.csv'.format(test_region))
    ...
    #DATA_ATTR.loc[DATA_ATTR['Region'] == test_region, 'Alt_Sig'] = alt_pval
    ...
    #DATA_ATTR.loc[DATA_ATTR['Region'] == test_region, 'Alt_Slope'] = alt_trend

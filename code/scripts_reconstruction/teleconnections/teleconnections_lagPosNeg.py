...
def extract_model_coefs_short(region, model, link, dis):
    ...
    #DATA_ATTR.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/Lag_PosNeg_ENSO_PDO_NAO_GMT_Loo.csv')     
...
for i, test_region in enumerate(test_regions):
    ...
    #loo_df_pos.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/Lag_ENSO_PDO_NAO_GMT_LooIC_{}Pos.csv'.format(test_region))
    ...
    #loo_df_neg.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/Lag_ENSO_PDO_NAO_GMT_LooIC_{}Neg.csv'.format(test_region))
    ...
    DATA_ATTR.to_csv('/home/insauer/projects/Attribution/Floods/Paper_NC_Resubmission_data/Teleconnections/Alt_PosNeg_test_GLB_AUS_GMT_Loo.csv')

...
for i in range(4):
    for j in range(3):
        ...
        if r in [0,1,4,7]:
            f3_ax1.set_ylabel('Relative trend in % per year', fontsize=7, labelpad = 2.5)
...
f3_ax4.legend(handles = [cli_box, cli2_box, exp_box,vul_box, imp_box,nat_box], frameon=True, fontsize = 7., loc = 'center', edgecolor = 'k')  

plt.savefig('/home/insauer/projects/NC_Submission/Data/Figures/Mainfigures/Figure3.png',bbox_inches = 'tight',dpi =600)
